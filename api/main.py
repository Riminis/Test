class Alcogol():
    def people_in_building(self, floors, square, type_building):
    ...
    def passenger_flow_metro(self, people_new_building, coord_centre, nearest_station):
        people_flow_out_m = -1
        people_flow_in_m = -1
    ...
    def find_nearest_station(self, my_location, metro_data):
        nearest_station = []
    ...
    def find_nearest_road(self, my_location, road_data):
